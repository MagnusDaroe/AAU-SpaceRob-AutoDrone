...
private:
    ...
    { 
        ...
        double time_since_epoch_double = time_since_epoch.count()*1000000000;
    ...
    // PD controller for altitude
    {
        ...
        float hover_value = 550;        // controller value for hovering (found by m*g/thrust to newton relation)
