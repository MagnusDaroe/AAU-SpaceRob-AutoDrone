...
def undistort_rectify_func(intrinsics):
    ...
    return undistort_rectify, max_disp, K_left, D_left
...
try:
    ...
    undistort_rectify, max_disp, K_left, D_left = undistort_rectify_func(intrinsics)
    ...
    while stop==True:
        ...
        if left_frame:
            ...
            #        cv2.aruco.drawAxis(image_rgb, K_left, D_left, rvec[i], tvec[i], 0.1)
