...
class T265(Node):
    ...
    def update_position(self,P_vicon_FC):
        """Update the global position of the drone
        """
        diff_x=self.T_global_vicon@P_vicon_FC[0]-self.t_vec_global_FC[0] #mm
        diff_y=self.T_global_vicon@P_vicon_FC[1]-self.t_vec_global_FC[1] #mm
        diff_z=self.T_global_vicon@P_vicon_FC[2]-self.t_vec_global_FC[2] #mm
